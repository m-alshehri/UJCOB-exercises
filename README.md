...
- **Learning paths** (`pathways.html`) order each course's original 25 concepts into 4–5 stages. A step is ready after at least three distinct questions within 30 days and 70% accuracy. All steps stay available; the first incomplete stage is recommended. Two correct diagnostic concepts can provisionally move the starting point beyond a stage; they do not mark it mastered, and later practice overrides that provisional placement. This is practice evidence, not certification.
