window.I18n = (() => {
  ...
  Object.assign(dictionary,{"Create your tamareen account": "أنشئ حسابك في تمارين", "Reset your password": "استعادة كلمة المرور", "Choose a new password": "اختر كلمة مرور جديدة", "Enter your email to receive a password reset link.": "أدخل بريدك الإلكتروني لإرسال رابط استعادة كلمة المرور.", "Save your personal practice and follow your learning progress.": "احفظ تدريبك الشخصي وتابع تقدمك التعليمي.", "Create account": "إنشاء الحساب", "Send reset link": "إرسال رابط الاستعادة", "Save new password": "حفظ كلمة المرور الجديدة", "Forgot password?": "نسيت كلمة المرور؟", "Enter a valid email address.": "أدخل بريدًا إلكترونيًا صحيحًا.", "Enter your password.": "أدخل كلمة المرور.", "Use a password with at least 8 characters.": "استخدم كلمة مرور من ٨ أحرف على الأقل.", "Passwords do not match.": "كلمتا المرور غير متطابقتين.", "Enter your name.": "أدخل اسمك.", "If this email has an account, a reset link will arrive shortly.": "إذا كان البريد مسجلًا فسيصل رابط الاستعادة قريبًا.", "Account created. Check your email to confirm your account, then log in.": "أُنشئ الحساب. أكد بريدك الإلكتروني ثم سجّل الدخول.", "Authentication failed. Please try again.": "تعذّر تسجيل الدخول. حاول مجددًا.", "Assign practice": "إسناد تدريب", "Title": "العنوان", "Type": "النوع", "One practice quiz": "اختبار تدريبي واحد", "Selected lab exercises": "تمارين مختبر محددة", "Exercises": "التمارين", "Due date (your local time, optional)": "موعد التسليم (بتوقيتك المحلي، اختياري)", "Assign to group": "إسناد للمجموعة", "No assignments yet.": "لا توجد واجبات بعد.", "No recent reports.": "لا توجد بلاغات حديثة.", "Group code not found": "لم نعثر على رمز المجموعة", "Enter a valid group code": "أدخل رمز مجموعة صحيحًا", "Your Python code": "كود بايثون", "Your SQL code": "كود SQL", "HTML, CSS and JavaScript code": "كود HTML وCSS وJavaScript", "Course slide set covering introduction, expressions, conditions, functions, iterations, strings, lists and dictionaries.": "شرائح المقرر للمقدمة والتعبيرات والشروط والدوال والتكرار والنصوص والقوائم والقواميس.", "Connolly & Hoar chapter materials covering the foundations of web design and development.": "مواد فصول Connolly وHoar لأساسيات تصميم الويب وتطويره.", "Kroenke 9e course materials, including core database concepts, SQL and database design topics.": "مواد Kroenke، الطبعة التاسعة، لمفاهيم قواعد البيانات وSQL وتصميم قواعد البيانات.", "Motiwalla course materials, chapters 1–12.": "مواد Motiwalla، الفصول ١–١٢.", "Sharda 11e course materials covering analytics, data, modeling and related decision-support topics.": "مواد Sharda، الطبعة الحادية عشرة، للتحليل والبيانات والنمذجة ودعم القرار.", "Sharda course materials used across the Business Intelligence chapters.": "مواد Sharda المستخدمة في فصول ذكاء الأعمال.", "Practice business intelligence decisions using KPIs, visualization, data warehousing, dashboards and analytics scenarios aligned with the course.": "تدرّب على قرارات ذكاء الأعمال باستخدام مؤشرات الأداء والتصور ومستودعات البيانات ولوحات المعلومات والتحليلات.", "Practice data preparation, descriptive and predictive analytics, model evaluation and prescriptive decision scenarios aligned with the course.": "تدرّب على إعداد البيانات والتحليل الوصفي والتنبؤي وتقييم النماذج واتخاذ القرار.", "Practice integrated enterprise processes, shared data, module relationships and ERP implementation decisions through short business scenarios.": "تدرّب على عمليات المؤسسة المتكاملة والبيانات المشتركة وعلاقات الوحدات وقرارات تنفيذ ERP عبر سيناريوهات قصيرة.", "Write real code, run it in the browser, and use progressive hints and automatic feedback to improve your solution.": "اكتب كودًا فعليًا وشغّله في المتصفح، واستفد من التلميحات المتدرجة والفحص التلقائي لتحسين الحل.", "Write and run Python code with automatic test cases.": "اكتب وشغّل كود بايثون مع اختبارات تلقائية.", "Write and execute SQL queries against a practice database.": "اكتب ونفّذ استعلامات SQL على قاعدة بيانات للتدريب.", "Write HTML, CSS and JavaScript with a live preview and automatic task checks.": "اكتب HTML وCSS وJavaScript مع معاينة مباشرة وفحص تلقائي.", "Practice integrated ERP processes, shared data and implementation decisions.": "تدرّب على عمليات ERP المتكاملة والبيانات المشتركة وقرارات التنفيذ.", "Practice KPIs, dashboards, visualization and BI analytics decisions.": "تدرّب على مؤشرات الأداء ولوحات المعلومات والتصور وقرارات ذكاء الأعمال.", "Practice data preparation, predictive analytics and model evaluation.": "تدرّب على إعداد البيانات والتحليل التنبؤي وتقييم النماذج.", "The quiz could not start. Return to the course and try again.": "تعذّر بدء التدريب. ارجع إلى المقرر وحاول مجددًا.", "Loading questions…": "جارٍ تحميل الأسئلة…", "No questions are available for this course.": "لا توجد أسئلة متاحة لهذا الاختيار.", "Attempt resumed. Submitted answers and the original exam deadline are preserved.": "استُكملت المحاولة مع الاحتفاظ بالإجابات المحفوظة وموعد انتهاء الاختبار الأصلي.", "This attempt is complete. View My Progress for the result.": "هذه المحاولة مكتملة. شاهد النتيجة في صفحة تقدمي.", "Build a broader picture": "كوّن صورة أوضح عن مستواك", "More distinct questions are needed before identifying a weak topic.": "نحتاج إلى أسئلة مختلفة أكثر قبل تحديد موضوع يحتاج إلى تدريب.", "Your assessed topics are doing well. Try varied questions to broaden your practice.": "أداؤك جيد في الموضوعات المقيمة. جرّب أسئلة متنوعة لتوسيع تدريبك.", "More practice builds confidence": "المزيد من التدريب يعزز الثقة", "Varied practice · recent evidence · no verified grade": "تدريب متنوع · أدلة حديثة · ليست درجة معتمدة", "Tutor is temporarily unavailable. Please try later.": "المساعد غير متاح مؤقتًا. حاول لاحقًا.", "Tutor is not configured yet. Practice remains available.": "المساعد غير مهيأ حاليًا. التدريب متاح.", "Tutor limit reached. Try later (6 requests per minute, 60 per day).": "بلغت حد المساعد. حاول لاحقًا (٦ طلبات في الدقيقة و٦٠ يوميًا).", "Report limit reached": "بلغت الحد اليومي للبلاغات", "Submission limit reached": "بلغت الحد اليومي للتسليمات", "Join the group before submitting": "انضم إلى المجموعة قبل التسليم", "Draft changed. Reload before saving.": "تغيّرت المسودة. أعد تحميلها قبل الحفظ.", "Question was revised elsewhere. Start from the current version.": "عُدّل السؤال في مكان آخر. ابدأ من النسخة الحالية.", "Enter three incorrect options": "أدخل ثلاثة خيارات غير صحيحة", "Options must be distinct": "يجب أن تكون الخيارات مختلفة", "Explain every option": "اشرح كل خيار"});
  let lang;
  try {
