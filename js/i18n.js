window.I18n = (() => {
  const dictionary = {
    "Explore course →": "استكشف المقرر ←",
    "Build programming foundations and solve business problems with Python.": "ابنِ أساسك البرمجي وحل مسائل الأعمال باستخدام Python.",
    "Explore business processes and their integration through ERP systems.": "افهم عمليات المؤسسة وتكاملها عبر أنظمة ERP.",
    "Turn your ideas into interactive web pages.": "حوّل أفكارك إلى صفحات ويب تفاعلية.",
    "Turn data into insights that support business decisions.": "حوّل البيانات إلى رؤى تدعم اتخاذ القرار.",
    "Analyze business data and draw actionable conclusions.": "حلّل بيانات الأعمال واستخلص نتائج قابلة للتطبيق.",
    "Design databases and practice SQL queries.": "صمّم قواعد البيانات وتدرّب على استعلامات SQL.",
    Learn: "التعلّم",
    "My learning": "متابعتي",
    Classroom: "الفصل الدراسي",
    Teaching: "أدوات المدرّس",
    Account: "حسابي",
    "Sign in": "دخول",
    "Groups & assignments": "المجموعات والتكليفات",
    "Submissions & feedback": "التسليمات والملاحظات",
    "Practice and assessments": "تدريب واختبارات",
    "Step-by-step learning": "خطوات تعلّم مرتبة",
    "Hands-on practice": "تطبيق عملي للمهارات",
    "Course projects": "مشاريع المقررات",
    "References and resources": "مصادر ومواد مساندة",
    "Your next activity": "خطوتك التالية",
    "Results and skills": "النتائج والمهارات",
    "Questions to revisit": "أسئلة تستحق المراجعة",
    "Groups and deadlines": "المجموعات والمواعيد",
    ...
    "Choose a lab to practise your course skills.":
      "اختر مختبرًا لتطبيق مهارات المقرر.",
    "Choose a project, read the requirements, practise in the lab, then submit your work and tests.":
      "اختر مشروعًا واقرأ متطلباته وتدرّب في المختبر، ثم سلّم عملك واختباراتك.",
    "All courses": "جميع المقررات",
    Deliverables: "المخرجات المطلوبة",
    Example: "مثال",
    "Executable tests in the lab": "اختبارات تنفيذية داخل المختبر",
    "Instructor-reviewed project: submit your work and evidence.":
      "يقيّم المدرس هذا المشروع: سلّم عملك والأدلة الداعمة.",
    ...
    "Local storage unavailable. Keep this page open until cloud saving succeeds.":
      "التخزين المحلي غير متاح. أبقِ الصفحة مفتوحة حتى ينجح الحفظ السحابي.",
    "Local draft restored.": "تمت استعادة المسودة المحلية.",
    "Your edits will be saved on this device.":
      "ستُحفظ تعديلاتك على هذا الجهاز.",
    "Saved on this device. Cloud saving pending.":
      "تم الحفظ على هذا الجهاز، وبانتظار الحفظ السحابي.",
    "Saved on this device. Reconnect to sync.":
      "تم الحفظ على هذا الجهاز. ستتم المزامنة عند عودة الاتصال.",
    "Draft changed on another device. Load the cloud draft before saving.":
      "تغيرت المسودة من جهاز آخر. حمّل المسودة السحابية قبل الحفظ.",
    "Cloud draft differs. Choose the cloud version or keep your local version.":
      "تختلف المسودة السحابية. اختر النسخة السحابية أو احتفظ بنسختك المحلية.",
    ...
    "Some activities could not load. Refresh to retry.":
      "تعذر تحميل بعض الأنشطة. حدّث الصفحة لإعادة المحاولة.",
    "Your next step, reviews and assignments in one place.":
      "خطوتك التالية والمراجعات والتكليفات في مكان واحد.",
    ...
    "Sign in with the same account to save this result.":
      "سجّل الدخول بالحساب نفسه لحفظ هذه النتيجة.",
